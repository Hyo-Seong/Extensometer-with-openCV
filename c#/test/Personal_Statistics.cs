...
namespace test
{
    public partial class Personal_Statistics : Form
    {
        ...
        public Personal_Statistics()
        {
            ...
            string selectString = string.Format("SELECT * FROM user_score where user_name=\"{0}\";", name);
            ...
            try
            {
                while (rdr.Read())
                {
                    ...
                    label19.SetBounds(535, x, 100, 30);
        ...
        private void Personal_Statistics_Load(object sender, EventArgs e)
        {

        }

        private void Personal_Statistics_Load_1(object sender, EventArgs e)
        {
